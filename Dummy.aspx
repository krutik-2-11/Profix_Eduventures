...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <div>
            <asp:Label ID="lblId" BorderWidth="2px" ForeColor="Yellow" runat="server" Height="17px" Width="40px"></asp:Label>
            <asp:Label ID="lblName" BorderWidth="2px" ForeColor="YellowGreen" runat="server"></asp:Label>
